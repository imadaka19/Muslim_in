...
import 'package:muslim_in/view/SlidingPanel.dart';
import 'package:muslim_in/view/almatsurat.dart';

import 'package:muslim_in/view/sidemenu.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        //           return ListView.builder(itemBuilder: (context, user) {
        //             return RichText(
        //               text: TextSpan(
        //                 text: "Halo, ",
        //                 style: TextStyle(fontSize: 18),
        //                 children: [
        //                   TextSpan(
        //                     text: getusername(documentId: docIDs[user])
        //                         .toString(),
        //                     style: TextStyle(
      ...
      body: Stack(
        children: [
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  // Fitur(
                  //   title: "Resto Halal",
                  //   icon: 'sources/fitur/halal kotak.png',
                  //   file: Resto(),
                  // ),
                  Column(
                    children: [
          ...
          ProviderScope(child: SlidingupPanel()),
        ],
      ),
    );
  }
...
class MapUtils {
  ...
  static Future<void> openMap() async {
    String googleUrl = 'https://www.google.co.id/maps/search/mosque masjid';
